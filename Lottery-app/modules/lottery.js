...
export default class Lottery {
    constructor(people){ // povezivanje isto
        this.people = people; 
        this.players = []; // povezivanje s people iz parametra, politicians je argument
    ...
    generatePlayers() {
        this.people.map((person) => {
            ...
            const player = new Player(person.name, person.surname, this.getLotteryNumbers());
